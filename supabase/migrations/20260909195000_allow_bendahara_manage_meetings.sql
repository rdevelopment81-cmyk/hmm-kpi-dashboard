-- Update policy to also allow bendahara to manage meetings
DROP POLICY IF EXISTS "meetings proker admin manage" ON public.meetings;
...
-- Update record_attendance to also allow bendahara
...
BEGIN
  ...
  -- If not hr_admin/kadiv, check if user is proker admin (ketua_pelaksana/sekretaris/bendahara)
